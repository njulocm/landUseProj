...
class MobileNetV2(nn.Module):
    def __init__(self, output_stride=8, BatchNorm=None, width_mult=1.,input_channel_0=3, pretrained=True):
        ...
        self.features = [conv_bn(input_channel_0, input_channel, 2, BatchNorm)]
        current_stride *= 2
