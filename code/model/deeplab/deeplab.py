...
class DeepLabV3P(nn.Module):
    def __init__(self, backbone='resnet', output_stride=16, input_channel = 3,num_classes=21,
        ...
        self.backbone = build_backbone(backbone,input_channel, output_stride, BatchNorm,pretrained)
...
if __name__ == "__main__":
    model = DeepLabV3P(backbone='mobilenet', output_stride=16)
    model.eval()
