...
logfile = root_dir + '/code/log/smp_unetpp_deep_pretrain_b7_chnl4-rgb_argu_discolor-alltrain-0228.log'
...
model_cfg = dict(
    ...
    pretrained=True,
    check_point_file=root_dir + '/code/checkpoint/smp_unetpp_deep_pretrain_b7_chnl4-rgb_argu_discolor-alltrain-0228/smp_unetpp_best.pth',
...
test_cfg = dict(
    ...
    check_point_file=root_dir + '/code/checkpoint/smp_unetpp_deep_pretrain_b7_chnl4-rgb_argu_discolor-alltrain-0228/smp_unetpp_best.pth',
    out_dir=root_dir + '/prediction_result/smp_unetpp_deep_pretrain_b7_chnl4-rgb_argu_discolor-alltrain-0228/',
)
