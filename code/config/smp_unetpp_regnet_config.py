...
info = 'SmpUnetpp-regx320，scse-atte，全数据训练45轮'  # 可以在日志开头记录一些补充信息
logfile = f'../user_data/log/round2_regx320_SmpUnetpp-alltrain-0323.log'
...
dataset_cfg = dict(
    ...
    # val_dir_list=['../tcdata/validation0'],
...
model_cfg = dict(
    ...
    pretrained=True,
    device=device,
    check_point_file=f'../user_data/checkpoint/round2_regx320_SmpUnetpp-alltrain-0323/SmpUnetpp_best.pth',
)
