...
logfile = root_dir + '/code/log-smp_unetpp_nopretrain-argu_color-0209.log'
...
model_cfg = dict(
    ...
    pretrained=True,
    check_point_file=root_dir + '/code/checkpoint/smp_unetpp_nopretrain-argu_color-0209/smp_unetpp_best.pth',
...
test_cfg = dict(
    ...
    check_point_file=root_dir + '/code/checkpoint/smp_unetpp_nopretrain-argu_color-0209/smp_unetpp_best.pth',
    out_dir=root_dir + '/prediction_result/smp_unetpp_nopretrain-argu_color-0209/',
)
