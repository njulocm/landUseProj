...
model_cfg = dict(
    ...
    pretrained=True,
    device=device,
    check_point_file=f'../user_data/checkpoint/round2_b0_SmpUnetpp_color_alldata-0406/SmpUnetpp_best.pth',
...
train_cfg = dict(
    ...
    is_swa=False,
    # check_point_file=f'../user_data/checkpoint/round2_b0_SmpUnetpp_9v1-0327/SmpUnetpp_best-epoch44.pth',
    # swa模型读取地址
)
...
test_cfg = dict(
    ...
    check_point_file=[
        ...
        '../user_data/checkpoint/round2_b0_SmpUnetpp_color_swa96_alldata-0406/SmpUnetpp_best-epoch23.pth',
        '../user_data/checkpoint/round2_b0_SmpUnetpp_chnl512_alldata-0408/SmpUnetpp_best-epoch44.pth',

        # '../user_data/checkpoint/channel256/model.pth',
        # '../user_data/checkpoint/round2_b0_SmpUnetpp_swa48_alldata-0330/SmpUnetpp_best-epoch92.pth',
        # '../user_data/checkpoint/round2_b0_depth4_256_SmpUnetpp-0330/SmpUnetpp_best-epoch92.pth',
        # '../user_data/checkpoint/round2_b0_SmpUnetpp_T2-0404/SmpUnetpp_best-epoch61.pth',
